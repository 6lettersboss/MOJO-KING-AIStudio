...
const Login: React.FC<LoginProps> = ({ onNavigate }) => {
    ...
    const { loginWithProvider, loginWithEmail, signupWithEmail, mockKakaoLogin } = useAuth();
    ...
    const handleSocialLogin = async (providerName: 'google' | 'apple' | 'kakao') => {
        ...
        try {
            if (providerName === 'google') {
                await loginWithProvider(new firebase.auth.GoogleAuthProvider());
            } else if (providerName === 'apple') {
                await loginWithProvider(new firebase.auth.OAuthProvider('apple.com'));
